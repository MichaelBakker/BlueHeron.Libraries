    ...
    public readonly struct NotifyCollectionChangedEventArgs<T>
    {
        ...
        public NotifyCollectionChangedEventArgs ToStandardEventArgs()
        {
            return Action switch
            {
                ...
                NotifyCollectionChangedAction.Move => new NotifyCollectionChangedEventArgs(Action, OldItem),
        ...
        /// <summary>
        /// Creates a new <see cref="NotifyCollectionChangedEventArgs{T}"/> that represents an <see cref="NotifyCollectionChangedAction.Reset"/> operation.
        /// </summary>
        /// <returns>A <see cref="NotifyCollectionChangedEventArgs{T}"/></returns>
