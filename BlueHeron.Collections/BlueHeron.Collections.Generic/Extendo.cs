...
{
    /// <summary>
    /// Adapted from: https://weblog.west-wind.com/posts/2012/feb/08/creating-a-dynamic-extensible-c-expando-object.
    /// Class that provides extensible properties and methods. This dynamic object stores 'extra' properties in a mDictionary or checks the actual properties of the instance.
    /// This means you can subclass this expando and retrieve either native properties or properties from values in the mDictionary.
    /// This type allows you three ways to access its properties:
    ///     Directly: any explicitly declared properties are accessible
    ///     Dynamic: dynamic cast allows access to mDictionary and native properties/methods
    ...
    public class Extendo : DynamicObject, IDynamicMetaObjectProvider
    {
        ...
        /// <summary>
        /// This constructor just works off the internal mDictionary and any public properties of this object.
        /// </summary>
        public Extendo()
        {
            Initialize(this);
        ...
        /// <summary>
        /// Constructor that allows passing in an existing instance variable to 'extend'.        
        /// </summary>
        /// <remarks>
        /// You can pass in null here if you don't want to check native properties and only check the Dictionary.
        /// </remarks>
        /// <param name="instance">The instance variable</param>
        ...
        /// </summary>
        /// <remarks>
        /// The getter checks the Properties mDictionary first then looks in PropertyInfo for properties.
        /// The setter checks the instance properties before checking the Properties mDictionary.
        /// </remarks>
        ...
        public override bool TrySetMember(SetMemberBinder binder, object value)
        {
            ...
            Properties[binder.Name] = value; // no match - set or add to mDictionary
            return true;
        }
