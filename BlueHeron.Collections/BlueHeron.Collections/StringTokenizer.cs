...
public partial class StringTokenizer
{
	...
	/// <summary>
	/// The <see cref="Regex"/> that is used to split text into words.
	/// </summary>
    ...
    /// If the IFormatProvider is null, the thread's <see cref="IFormatProvider"/> is used. 
	...
	/// <summary>
	/// Initializes the StringTokenizer with the string to tokenize, the character that represents quotes and the list separator.
	/// </summary> 
	/// <param name="str">The string to tokenize</param>
    ...
    /// <summary>
    /// Get the numeric list separator for a given <see cref="IFormatProvider"/>.
    ...
    public static char GetNumericListSeparator(IFormatProvider provider)
	{
		...
		var numberFormat = NumberFormatInfo.GetInstance(provider); // get the NumberFormatInfo out of the provider, if possible. If the IFormatProvider doesn't not contain a NumberFormatInfo, then the current culture's NumberFormatInfo is returned
	...
	/// <summary>
	/// Initialize the StringTokenizer with the string to tokenize, the character that represents quotes and the list separator.
	/// </summary> 
	/// <param name="str">The string to tokenize</param>
